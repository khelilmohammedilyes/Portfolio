<div {{ $attributes->merge(['class' => 'flex items-center']) }}>
    <a href="https://www.facebook.com/ilyes.kun.5" target="_blank"
        class="
         w-10
         h-10
         flex
    ...
    <a href="https://www.linkedin.com/in/mohammed-ilyes-khelil-ba521b277/" target="_blank"
        class="
       w-10
       h-10
       flex
    ...
    <a href="https://github.com/khelilmohammedilyes" target="_blank"
        class="
       w-10
       h-10
       flex
    ...
    <a href="https://www.instagram.com/medilyes_khelil" target="_blank"
        class="
       w-10
       h-10
       flex
